 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
abstract class qtype_vmchecker_format_renderer_base extends plugin_renderer_base {
    /**
...
/**
 * An vmchecker format renderer for vmcheckers where the student should not enter
 * any inline response.
 *
 * @copyright  2013 Binghamton University
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_vmchecker_format_noinline_renderer extends plugin_renderer_base {

    protected function class_name() {
        return 'qtype_vmchecker_noinline';
    }
...
/**
 * An vmchecker format renderer for vmcheckers where the student should use the HTML
 * editor without the file picker.
 *
 * @copyright  2011 The Open University
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_vmchecker_format_editor_renderer extends plugin_renderer_base {
    protected function class_name() {
        return 'qtype_vmchecker_editor';
    }

    public function response_area_read_only($name, $qa, $step, $lines, $context) {
        return html_writer::tag('div', $this->prepare_response($name, $qa, $step, $context),
                ['class' => $this->class_name() . ' qtype_vmchecker_response readonly',
    ...
    public function response_area_input($name, $qa, $step, $lines, $context) {
        ...
        $output .= html_writer::start_tag('div', array('class' =>
                $this->class_name() . ' qtype_vmchecker_response'));
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_vmchecker_format_editorfilepicker_renderer extends qtype_vmchecker_format_editor_renderer {
    protected function class_name() {
        return 'qtype_vmchecker_editorfilepicker';
    }
    ...
    protected function specific_filepicker_options($acceptedtypes, $draftitemid, $context) {
        debugging('qtype_vmchecker_format_editorfilepicker_renderer::specific_filepicker_options() is deprecated, ' .
...
/**
 * An vmchecker format renderer for vmcheckers where the student should use a plain
 * input box, but with a normal, proportional font.
 *
 * @copyright  2011 The Open University
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_vmchecker_format_plain_renderer extends plugin_renderer_base {
    /**
     * @return string the HTML for the textarea.
     */
    protected function textarea($response, $lines, $attributes) {
        $attributes['class'] = $this->class_name() . ' qtype_vmchecker_response form-control';
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_vmchecker_format_monospaced_renderer extends qtype_vmchecker_format_plain_renderer {
    protected function class_name() {
        return 'qtype_vmchecker_monospaced';
    }
}
