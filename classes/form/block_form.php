...
class block_form extends moodleform {
    ...
    public function definition() {
        ...
        $mform->addElement(
            ...
            'Action',
            array(
                block_form::ACTION_RECHECK => get_string('action_recheck', 'block_vmchecker'),
                block_form::ACTION_RECHECK_ALL => get_string('action_recheck_all', 'block_vmchecker'),
                block_form::ACTION_MOSS => get_string('action_moss', 'block_vmchecker'),
            ),
            array('id' => $select_id)
        );
        ...
        <script>
            ...
            function selectAction() {
                ...
                if (selectValue === "' . block_form::ACTION_RECHECK_ALL . '") {
